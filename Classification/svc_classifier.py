...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 18 12:40:27 2019
...
print(score1)                 ##### [0.78688525   0.78333333   0.71666667   0.9   0.93220339]
print(np.average(score1))    #####  0.8238177271464295
print(score1.mean())
...
sc1=StandardScaler()
x_train=sc1.fit_transform(trainX)
x_test=sc1.fit_transform(testX)
